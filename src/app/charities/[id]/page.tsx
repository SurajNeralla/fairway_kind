...
const SAMPLE_CHARITY_FALLBACKS: Record<string, any> = {
  'c1000000-0000-0000-0000-000000000001': {
    ...
    logo_url: '🍲',
    events: [
      { date: 'Oct 15, 2026', title: 'Mid-Day Meal Support Campaign' },
      { date: 'Nov 02, 2026', title: 'Classroom Nutrition Drive' },
    ],
  },
  'c2000000-0000-0000-0000-000000000002': {
    ...
    logo_url: '👶',
    events: [
      { date: 'Oct 22, 2026', title: 'Child Health & Education Summit' },
      { date: 'Nov 18, 2026', title: 'Child Protection Awareness Walk' },
    ],
  },
  'c3000000-0000-0000-0000-000000000003': {
    ...
    logo_url: '🌱',
    events: [
      { date: 'Oct 28, 2026', title: 'Rural Community Essential Drive' },
      { date: 'Nov 24, 2026', title: 'Disaster Relief Materials Mobilization' },
    ],
  },
  'c4000000-0000-0000-0000-000000000004': {
    ...
    logo_url: '📚',
    events: [
      { date: 'Nov 05, 2026', title: 'Fellowship Teaching Showcase' },
      { date: 'Dec 01, 2026', title: 'Underserved Schools Leadership Summit' },
    ],
  },
  'c5000000-0000-0000-0000-000000000005': {
    ...
    logo_url: '☀️',
    events: [
      { date: 'Nov 12, 2026', title: 'Mobile Healthcare & Wellness Camp' },
      { date: 'Dec 15, 2026', title: 'Youth Livelihood Training Workshop' },
    ],
  },
};
